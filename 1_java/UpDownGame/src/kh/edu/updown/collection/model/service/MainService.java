      ...
      if(members.size() >=3) {
    	  ...
    	  while(true) {
    		  ...
    		  for(Member str : members) {
    			  ...
    			  if(!members.isEmpty()) {
    				  ...
    				  if(memberId.equals(str.getMemberId())) {
    	...
    	while(true) {
   			...
   			if(!memberPw.equals(memberPw2)) {
   				System.out.print("입력된 비밀번호가 동일하지 않습니다.\n");
   	    ...
   	    members.add(new Member(memberId,memberPw,memberName));
   ...
   public void login() {
	  ...
	  for(Member str : members) {
		  ...
		  if(!members.isEmpty()) {
			  ...
			  if(str.getMemberId().equals(memberId) &&
					  str.getMemberPw().equals(memberPw)) {
