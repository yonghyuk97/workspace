...
public class ArrayExample2 {
	...
	public void deepCopy() {
		   ...
		   //                     복사배열 , 복사배열의 삽입 싲가 인덱스 , 복사길이);
		   
		   int[] coayArr2 = new int[arr.length];
		   System.arraycopy(arr,0, coayArr2,0, arr.length);
		   
		   // 3. 복사할 배열 참조 변수 = Arrays.copiof(원본 배열, 복사할 길이
		...
		System.out.println("copyArr2 : " + Arrays.toString(coayArr2));
