...
public class User {
	...
	public User() {} // Duplicate field User.userId
	...
	*/
	...
	//public User() {} // 기본 생성자가 이미 작성되어 있어서 중복
	  ...
	  public User(String userId) {} // 매개변수 개수가 같은 생성자 없음
		                            // -> 오버로딩 성립
