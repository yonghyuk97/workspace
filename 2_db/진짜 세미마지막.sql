grant create any job to realsemi_CYH; -- 프로시저 사용하려면 사용자명에 자기꺼 넣기
...
-- 댓글 더미 데이터 (Q/A 댓글)
INSERT INTO REPLY VALUES(SEQ_REPLY_NO.NEXTVAL,'저희 K-호텔 전 객실, 슬림/캡슐/카페에는 복도에 소화기함에 구급약품이 준비되어 있습니다. <br> 사용후 다음 응급 고객님을 위해 제자리에 보관해주세요. <br><br>단, 해열제, 진통제, 감기약과 같은 복용약의 경우 구비되어 있지 않습니다.',DEFAULT,DEFAULT,1,1);
INSERT INTO REPLY VALUES(SEQ_REPLY_NO.NEXTVAL,'저희 아이도 매번 아파서 호텔 갈때마다 물어보는데 항상 K-호텔은 준비가 되있어서 좋아요 ♥♥',DEFAULT,DEFAULT,2,1);
INSERT INTO REPLY VALUES(SEQ_REPLY_NO.NEXTVAL,'저희 K-호텔은 애왕동물과의 동반 입실이 불가능합니다.<br><br>이용에 불편을 드려 대단히 죄송하다는 말씀 드리며, 고객님의 많은 양해 부탁드립니다.. ',DEFAULT,DEFAULT,1,2);
INSERT INTO REPLY VALUES(SEQ_REPLY_NO.NEXTVAL,'저희 K-호텔은 전 객실 포함 건물 전체가 흡연금지 구역입니다. <br><br> 흡연은 건물 외부에서만 가능합니다.<br><br> 객실내에서 흡연하시는 경우 객실청소비용 30만원이 부과됩니다.',DEFAULT,DEFAULT,1,3);
INSERT INTO REPLY VALUES(SEQ_REPLY_NO.NEXTVAL,'저희 K-호텔은 퇴실 시간 이후에는 시간당 20,000원의 추가 요금이 발생합니다. <br><br> 14시 이후부터는 1박 요금이 부과됩니다.',DEFAULT,DEFAULT,1,4);
INSERT INTO REPLY VALUES(SEQ_REPLY_NO.NEXTVAL,'저흰 호텔이 너무 편해서 잠을 더 자버린 결과....<br> 6만원 내버렸네요...ㅎ 그래도 다음 이용에 할인 받을 수 있는 쿠폰 받아서 또 가려구요!!ㅋㅋ',DEFAULT,DEFAULT,4,4);
...
--INSERT INTO BOARD VALUES(SEQ_BOARD_NO.NEXTVAL,'리뷰 더미 데이터 4','리뷰 더미 데이터 4번 입니다. ㅗㅗ',DEFAULT,DEFAULT,3,4,4,4);
...
-- 태그 더미 데이터
--NSERT INTO TAG VALUES('깨끗해요',16,DEFAULT);
