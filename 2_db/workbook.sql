...
-- 누구인가? (국문학과의 '학과코드'는 '학과 테이블(DEPARTMENT)을 조회해서 찾아 내도록 하자)
...
-- 6. 춘 기술대학교는 총장을 제외하고 모든 교수들이 소속 학과를 가지고 있다. 그럼 
-- 춘 기술대학교 총장의 이름을 알아낼 수있는 SQL 문장을 작성하시오 
SELECT * FROM TB_DEPARTMENT;
...
-- 10. 02 학번 전주 거주자들의 모임을 만들려고 한다. 휴학한 사람들을 제외한 재학중인
