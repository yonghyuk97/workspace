...
public class EmailServiceImpl implements EmailService {
    ...
    private String fromEmail = "choiyonghyuk97@gmail.com"; // 메일 보내는 사람의 이메일 주소
    private String fromUsername = "수업용프로젝트"; // 메일 보내는 사람 닉네임
    ...
    public int signUp(String email, String title) {
        ...
        try {
            ...
            // 제목
            String subject = "[Board Project]"+title+" 인증코드"; // 이메일 받았을 때 제목
