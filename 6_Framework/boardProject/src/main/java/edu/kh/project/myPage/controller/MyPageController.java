...
public class MyPageController {
	...
	public String info(Member updateMember
		...
		//--------------------- 매개 변수 설명 ------------------------
		// Member updateMember : 수정할 닉네임, 전화번호 담긴 커멘드 객체
		...
		// RedirectAttributes ra : 리다이렉트 시 값 전달용 객체(request scope)
		//---------------------------------------------------------
	...
	public String secession(String memberPw
		...
		if(result > 0) {
			...
			cookie.setPath("/"); // 요청시 쿠키가 첨부되는 경로 지정
