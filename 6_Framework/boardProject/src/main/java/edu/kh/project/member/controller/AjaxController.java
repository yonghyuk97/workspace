...
public class AjaxController {
	...
	// 닉네임으로 전화번호 조회
	@GetMapping(value="/selectMemberTel")
	@ResponseBody
	...
	// 이메일이 일부라도 일치하는 모든회원을 조회
	@PostMapping(value="/selectMemberList" , produces = "application/json; charset=UTF-8")
	@ResponseBody
	public List<Member> selectMember(@RequestBody String input){
     ...
     * 			jackson : java에서 json을 쓰기 위한 라이브러리
     * */   
