...
<body>
    <main>
        ...
        <section class="board-detail">  
            ...
            <%-- 
                - 이미지는 IMG_ORDER 오름 차순으로 정렬된다
                - IMG_OFDER의 값이 0인 이미지가 썸네일이다
                -> imageList에서 썸네일이 있다면
                조회 되었을 때 IMG_ORDER가 0인 이미지가 imageList[0]에 저장되었을 것이다.
             --%>
    ...
    <%-- 누가 (로그인한 회원 번호) 어떤 게시글 (현재 게시글 번호) 좋아요를 클릭/취소
        ...
        로그인한 회원 번호 얻어오기
        1) ajax로 session에 있는 loginMember의 memberNo 반환
