...
import edu.kh.jdbc.service.EmployeeService;
...
public class EmployeeView {
	...
	public void printList(List<Employee> empList) {
						// Employee로 타입이 제한된 List == Employee만 담긴 List
	...
	public void updateEmployee() {
		...
		int empId = inputEmpId(); // 사번 입력 받은 메소드 호출 후 결과 반환 받기
	...
	public void updateBonus() {
		...
		if(result > 0 ) {
			System.out.printf("%s 부서의 보녀스율이 %.1f으로 변경되엇습니다.\n",deptCode,bonus);
		}else {
