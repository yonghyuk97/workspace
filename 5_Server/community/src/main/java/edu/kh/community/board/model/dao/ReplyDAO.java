	...
	public List<Reply> selectReplyList(Connection conn, int boardNo) throws Exception {
		...
		try {
			...
			while( rs.next() ) {
				...
				rpy.setReplyNo(rs.getInt(1));
				rpy.setReplyContent(rs.getString(2));
				rpy.setCreateDate(rs.getString(3));
				rpy.setBoardNo(rs.getInt(4));
				rpy.setMemberNo(rs.getInt(5));
				rpy.setMemberNickname(rs.getString(6));
				rpy.setProfileImage(rs.getString(7));
