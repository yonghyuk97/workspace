...
if(loginFrm != null){
    ...
    loginFrm.addEventListener("submit", e => {
        ...
        if(memberPw.value.trim().length == 0){
            ...
            memberPw.focus(); // 비밀번호 input태그에 초점 맞춤
...
function selectNickname(email){
    ...
    .catch(e => {console.log(e)}) // 예외 발생시 처리할 내용을 작성0
...
btn1.addEventListener("click", ()=>{
    ...
    .then( resp => resp.text()) // 파싱 = 데이터의 형태를 바꾸는것
    // resp : 응답 객체
...
btn2.addEventListener("click", ()=>{
    ...
    .then(member =>{
        ...
        result2.append(li2, li3, li4, li5, li6);
...
/* // -----------------------------------------------------------
// 웹소켓 테스트
// 1. SockJS 라이브러리 추가 --> main.jsp 하단에 작성
...
if( document.querySelector("input[name='memberEmail']") != null){
    ...
    if(saveId != undefined){ // 쿠키에 저장된 이메일이 있을 경우
